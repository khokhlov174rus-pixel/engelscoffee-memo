...
window.GAME_CONFIG = {
    ...
    game: {
        ...
        winMessage: "Поздравляем с победой!<br>Дарим вафли с клубникой и сметанным кремом, при заказе на сумму от 2500р, по промокоду {PROMO_CODE}.Воспользоваться промокодом можно на доставку и самовывоз, на сайте и в приложении. Промокод действует с момента запуска по 30.11.2025.",
        promoCode: "GAME",
